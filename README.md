...
### Tap-only cart controls / タップ中心の操作
...
### Intent switch: Need to buy / Want to visit / 依頼テンプレ切替
...
### Admin customization / 作成者によるカスタム管理
...
### Inbox status workflow / 受信箱ステータス管理
...
### Lock-screen push summary / ロック画面通知（要約）
